...
const capabilities = [
  {
    ...
    icon: "📞",
    items: [
      { title: "After-hours intake line", desc: "AI answers calls 24/7. Qualifies callers on case type, urgency, jurisdiction, and conflict check basics. Professional tone that matches your firm's standards.", tier: 1 },
      { title: "Consultation booking", desc: "Checks attorney availability, books consultations by practice area, and sends SMS confirmation with prep instructions to the prospect.", tier: 1 },
      { title: "Lead notification", desc: "Instant iMessage or SMS with full intake details — case type, urgency level, potential value, and recommended next steps.", tier: 1 },
      { title: "Bilingual intake", desc: "Handles calls in both English and Spanish. Same qualification process, natural conversation flow in either language.", tier: 2 },
    ],
  },
  {
    ...
    icon: "⚖️",
    items: [
      { title: "Practice area routing", desc: "Automatically routes leads to the right attorney based on case type — personal injury, family law, criminal defense, immigration, etc.", tier: 1 },
      { title: "Urgency classification", desc: "AI assesses urgency (statute of limitations, pending court dates, emergency situations) and flags high-priority intakes.", tier: 1 },
      { title: "Conflict pre-screening", desc: "Collects opposing party information during intake so your team can run conflict checks before the first meeting.", tier: 2 },
      { title: "Multi-location routing", desc: "For firms with multiple offices, routes calls to the correct location based on jurisdiction and attorney availability.", tier: 2 },
    ],
  },
  {
    category: "Follow-Up",
    icon: "🔄",
    items: [
      { title: "Speed-to-lead sequences", desc: "If a prospect doesn't book on the first call, automated follow-up fires within 5 minutes via SMS and email. Multiple touchpoints over 48 hours.", tier: 1 },
      { title: "Client status updates", desc: "Automated case milestone updates via SMS — filed, hearing scheduled, discovery complete — so clients stop calling for status.", tier: 2 },
      { title: "Long-term nurture", desc: "Monthly legal tips newsletter, seasonal check-ins, referral requests. Keeps your firm top-of-mind with past clients and prospects.", tier: 2 },
      { title: "Consultation reminders", desc: "48hr, 24hr, and 2hr reminders via SMS reduce no-shows and ensure prospects are prepared for their consultation.", tier: 2 },
    ],
  },
  {
    category: "Operations",
    icon: "⚙️",
    items: [
      { title: "CRM / case management sync", desc: "Every intake, call, and follow-up logged to Clio, MyCase, PracticePanther, or your case management system. Two-way sync.", tier: 1 },
      { title: "Google review requests", desc: "After case resolution, automated SMS asks satisfied clients to leave a Google review. Negative sentiment gets routed privately first.", tier: 1 },
      { title: "Weekly performance digest", desc: "Monday morning summary: intakes received, consultations booked, conversion rate, case value pipeline, and source attribution.", tier: 2 },
    ],
  },
];
    ...
    <section style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          Your AI Intake Coordinator.
        </h1>
        <p style={{
          fontSize: 14, fontFamily: "'DM Mono', monospace", color: "rgba(37,99,235,0.55)", margin: "0 0 20px",
        }}>
          Qualifies prospects · Routes by case type · Books consultations · Sends updates
        </p>
        <p style={{
          fontSize: "clamp(15px, 2vw, 18px)", fontWeight: 300,
          color: "rgba(255,255,255,0.4)", maxWidth: 520, lineHeight: 1.6, margin: "0 auto 36px",
        }}>
          A missed intake call is a missed retainer. Your AI qualifies every caller — day, night, weekend — and routes the right cases to the right attorney.
        </p>
    ...
    <section ref={ref} style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 15, fontWeight: 300, color: "rgba(255,255,255,0.38)", lineHeight: 1.6 }}>
          Slow response times cost law firms more retainers than bad reviews do.
        </p>
      </div>
      <div style={{
        ...
        {[
          { value: "35%", label: "calls go unanswered", sub: "during business hours" },
          { value: "$3,500+", label: "avg retainer value", sub: "per new client" },
          { value: "$5K+", label: "lost / month", sub: "from missed intakes" },
          { value: "$350", label: "your AI coordinator", sub: "per month, all-in" },
        ].map((m, i) => (
          <div key={i} style={{
  ...
  return (
    <section ref={ref} style={{
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: 18, fontWeight: 600, color: "#fff", margin: "0 0 4px" }}>Your AI Intake Coordinator</h3>
        <p style={{ fontSize: 12, color: "rgba(255,255,255,0.3)", margin: "0 0 24px" }}>For law firms</p>
        ...
        <div style={{ textAlign: "left", marginBottom: 24 }}>
          {["24/7 intake qualification", "Practice area routing", "Consultation booking + reminders", "Speed-to-lead follow-up", "Client status updates", "CRM / case management sync", "Google review generation", "Monthly optimization"].map((f, i) => (
            <div key={i} style={{
